...
@Named(value = "reportTotalUnidadSolicitanteController")
@ConversationScoped
public class ReportTotalUnidadSolicitanteController implements Serializable {
	...
	private String urlTotalUnidadSolicitante;
	...
	public void cargarReporte(){
		try {
			urlTotalUnidadSolicitante = loadURL();
			verReporte = true;
		} catch (Exception e) {
	...
	public String getUrlTotalUnidadSolicitante() {
		return urlTotalUnidadSolicitante;
	}

	public void setUrlTotalUnidadSolicitante(String urlTotalUnidadSolicitante) {
		this.urlTotalUnidadSolicitante = urlTotalUnidadSolicitante;
	}
