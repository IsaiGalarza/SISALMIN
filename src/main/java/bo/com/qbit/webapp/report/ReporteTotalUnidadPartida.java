...
@WebServlet("/ReporteTotalUnidadPartida")
public class ReporteTotalUnidadPartida  extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			if(pIdDetalleUnidad.equals("-1")){
				 rutaReporte = urlPath+"resources/report/totales_unidad_segun_partida_todos.jasper";
			}else{
			 rutaReporte = urlPath+"resources/report/totales_unidad_segun_partida_individual.jasper";
