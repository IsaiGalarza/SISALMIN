...
@WebServlet("/ReporteTotalUnidadProyecto")
public class ReporteTotalUnidadProyecto  extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			String pIdDetalleUnidad = request.getParameter("pIdDetalleUnidad");
			...
			if(pIdDetalleUnidad.equals("-1")){
				 rutaReporte = urlPath+"resources/report/totales_unidad_segun_proyecto_todos.jasper";
			}else{
			 rutaReporte = urlPath+"resources/report/totales_unidad_segun_proyecto_individual.jasper";
			 parameters.put("pIdDetalleUnidad", new Integer( pIdDetalleUnidad));
			}
			...
			e.printStackTrace();
			System.out.println("Error en reporte Total DetalleUnidad: " + e.getMessage());
